...
```{r, results}
stargazer(demand.data, type = "html")
...
In this particular example we are optimizing price to maximize revenue. I understand that's not always the metric that we are trying to maximize. We can also extend this and maximize profit, for that we will just need to include cost in our equation and obtain a profit function rather than just a total revenue function. (just a bit more algebra)
